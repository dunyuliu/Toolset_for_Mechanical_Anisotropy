...
%{ 
Summary
The code is to plot Figure 5 in the article for case 31.
...
addpath('./colormap/crameri'); % Use colormap crameri. License is attached under ./colormap/
path = '../res/case31/20220629/'; % Simulated on 20220121 for more thetas. 

theta = 12.5; % Set Theta  
hete = 1; 
